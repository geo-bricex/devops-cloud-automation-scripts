Instrucciones para configurar y ejecutar un entorno con Rust y Rocket en Windows utilizando PowerShell, y crear una aplicación sencilla que muestra "Hello, World!".
